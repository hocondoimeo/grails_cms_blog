...
<html>
	...
	<body>
		<a href="#create-categoryAdmin" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div role="navigation">
			<ul class="breadcrumb">
		...
		<div id="create-categoryAdmin" class="content scaffold-create" role="main">
