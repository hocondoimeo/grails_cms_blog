		...
		<div id="list-article" class="content scaffold-list" role="main">
			...
			<div id="search">
			  <g:form url='[controller: "admin/article", action: "list"]'
			    ...
			    <input type="submit" value="Search" class="search btn btn-primary" style="margin-bottom: 10px !important;"/>
			  </g:form>
			</div>
				...
				<table class="table table-bordered">
					<thead>
						<g:if test="${articleInstanceList || searchResult.results}">
						<tr>
					...
					<tbody>
						...
						<g:else>
							<div style="padding-top:100px">
							    ...
							    <g:if test="${searchResult?.suggestedQuery}">
							      <p>Did you mean <b><i><g:link controller="admin/article" action="list" params="[q: searchResult.suggestedQuery]">${StringQueryUtils.highlightTermDiffs(params.q.trim(), searchResult.suggestedQuery).replaceAll("<(.|\n)*?>", '')}</g:link></i></b>?</p>
							    </g:if>
