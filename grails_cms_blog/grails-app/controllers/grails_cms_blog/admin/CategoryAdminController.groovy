...
class CategoryAdminController {
    ...
    def index() {
        redirect(controller: "admin/category",action: "list", params: params)
    }
    ...
    def save() {
        ...
        redirect(controller: "admin/category",action: "show", id: categoryInstance.id)
    }
    ...
    def show(Long id) {
        ...
        if (!categoryInstance) {
            ...
            redirect(controller: "admin/category",action: "list")
            return
        }
    ...
    def delete(Long id) {
        ...
        try {
            ...
            redirect(controller: "admin/category",action: "show", id: id)
        }
    }
}
