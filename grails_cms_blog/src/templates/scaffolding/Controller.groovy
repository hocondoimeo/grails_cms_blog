...
class ${className}Controller {
    ...
    def index() {
        redirect(controller: "admin/${className.toLowerCase()}",action: "list", params: params)
    }
    ...
    def save() {
        ...
        redirect(controller: "admin/${className.toLowerCase()}",action: "show", id: ${propertyName}.id)
    }
    ...
    def show(Long id) {
        ...
        if (!${propertyName}) {
            ...
            redirect(controller: "admin/${className.toLowerCase()}",action: "list")
            return
        }
    ...
    def delete(Long id) {
        ...
        try {
            ...
            redirect(controller: "admin/${className.toLowerCase()}",action: "show", id: id)
        }
    }
}
